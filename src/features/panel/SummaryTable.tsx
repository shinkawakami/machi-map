  ...
  return (
    <>
      ...
      */}
      ...
      {/*
        **上の区画にも見出しを付ける。** 下の区画（指定避難所）だけが名乗っていて、
        上は無名のまま始まっていた。区切りの太線を挟んで片方だけラベルがあると、
        読む人には「上は何の一覧なのか」が分からない。

        **2つ並べたこの見出しが、この画面で主張2を言う場所になる。**
        詳細（ShelterDetailView）から役割の説明を外したので、その受け皿がここ。
